...
public class EagerCourseManager {
	private static final EagerCourseManager instance = new EagerCourseManager();
	private List<Student> students;
	private List<Course> courses;
	private List<Registration> registrations;

	public EagerCourseManager() {
		this.students = new ArrayList<Student>();
		this.courses = new ArrayList<Course>();
		this.registrations = new ArrayList<Registration>();
	}

	public static EagerCourseManager getInstance() {
		return instance;
	}
